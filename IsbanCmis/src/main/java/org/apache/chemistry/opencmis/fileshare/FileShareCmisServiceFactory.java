...
public class FileShareCmisServiceFactory extends AbstractServiceFactory {
    ...
    /**
     * Default maxItems value for getChildren() and other methods returning lists of
     * objects.
     */
    ...
    public SesionProDoc getSesProdoc() {
        return sesProdoc;
    }

    public void setSesProdoc(SesionProDoc sesProdoc) {
    ...
    public CmisService getService(CallContext context) {
        ...
        // Obtenemos la variable de entorno para el fichero prodoc.properties
        String fichProps = System.getenv("OPD_props");
...
//             context.getUsername(), context.getPassword());
    ...
    /**
     * Finds all substrings in curly braces and replaces them with the value of the
