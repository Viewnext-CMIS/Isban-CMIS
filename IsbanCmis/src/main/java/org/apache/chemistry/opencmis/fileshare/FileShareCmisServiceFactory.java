...
public class FileShareCmisServiceFactory extends AbstractServiceFactory {
    ...
    public CmisService getService(CallContext context) {
        ...
        if (service == null) {
            ...
            sesProdoc= new SesionProDoc("PD", "C:\\Datos\\JavaWjs_OpenCmis\\file-share\\src\\main\\webapp\\WEB-INF\\classes\\prodoc.properties", context.getUsername(), context.getPassword());
